...
mans.setStatus(`Mode : Public Created By Hamba Allah`)
}
break
case 'setstatut':
case 'setbio':
...
mans.setStatus(`Mode : Self Created By Hamba Allah`)
}
break
